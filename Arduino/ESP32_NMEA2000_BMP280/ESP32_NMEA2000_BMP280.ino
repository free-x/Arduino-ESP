...
// NMEA2000 Temperature and Pressure with BMP280
// Thx to AK-Homberger (https://github.com/AK-Homberger/)
// Version 0.1, 21.02.2021, free-x
...
void setup() {
  ...
  // Init BMP280 I2C address depends on sensor 0x77(default) or 0x76(old).
  if (!bmp.begin()) {
    if (!bmp.begin(0x76)) {
 ...
 // Set product information
  NMEA2000.SetProductInformation("1", // Manufacturer's Model serial code
                                 ...
                                 "BMP280 Sensor Module",  // Manufacturer's Model ID
